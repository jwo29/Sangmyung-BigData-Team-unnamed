...
#load directory
dir_loc_1 = os.listdir("/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/Stage_1_1")
location = "/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/Stage_1_1/"
...
mine_dir_loc = os.listdir("/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/mine")
mine_dir_loc.sort()
location = "/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/mine/"
...
#load directory
dir_loc_2 = os.listdir("/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/Stage_2_1")
location = "/Users/kimjuann/Downloads/Sangmyung_BigData_Team_J-AWS-main/Stage_2_1/"
...
index = np.arange(len(original_average))
plt.title("Compare (Stage2-1) and (Stage1, 2)")


print(original_average)
plt.bar(index, list(average_by_routeId.values()), 0.2, label="Stage2-1")
plt.bar(index+0.2, list(original_average.values()), 0.2, label="Stage1, 2")
plt.xticks(index, original_average)
plt.yticks(list(average_by_routeId.values()))
plt.ylabel("arrTime")
